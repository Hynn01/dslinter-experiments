...
get_ipython().system('curl https://github.com/dwgoon/jpegio/blob/master/dist/jpegio-0.2.1-cp37-cp37m-linux_x86_64.whl > ./jpegio/jpegio-0.2.1-cp37-cp37m-linux_x86_64.whl')
...
get_ipython().system('pip install ./jpegio/jpegio-0.2.1-cp37-cp37m-linux_x86_64.whl')
