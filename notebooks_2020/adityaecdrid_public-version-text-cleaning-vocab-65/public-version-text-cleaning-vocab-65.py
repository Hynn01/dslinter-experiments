...
get_ipython().run_cell_magic('time', '', "train['comment_text'] = train['comment_text'].progress_apply(lambda x: correct_contraction(x, contraction_mapping))\ntest['comment_text']  = test['comment_text'].progress_apply(lambda x: correct_contraction(x, contraction_mapping))\ngc.collect()")
