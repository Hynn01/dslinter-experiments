...
# <img src="https://i.imgur.com/qYzpZ5X.jpg" alt="corona" width="600">
# 
# It's great to see Kagglers contributing this way to fight the advance of Covid-19. I thought it might be helpful to share some thoughts on what makes a good report for this type of thing. My opinions come from experience being both the person reading reports and the person making reports - and the person getting told to revise and resubmit his report. Of course this notebook represents a single point of view, and you are probably best served by gathering many perspectives of what "good" looks like. 
...
#  
#  UPDATE: Other issues have risen in visibility as things progess:
#  - How did governemnts react, and what has been the correlation of these reactions with the infection rate?
#  - As countries restore freedom of movement after an outbreak, what happens in terms of infection rates?
...
# This is the actual HTML code you would put in a markdown cell .
