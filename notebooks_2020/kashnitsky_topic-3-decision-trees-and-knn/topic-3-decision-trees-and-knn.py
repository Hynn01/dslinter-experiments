...
# In the second example, the tree solved the problem perfectly while k-NN experienced difficulties. However, more likely, this a disadvantage of using Euclidean distance here. It did not allow us to reveal that one feature was much better than the others. 
...
# 
# ### Demo-version
# To practice with building classification decision trees with Scikit-learn, you can complete [this demo assignment](https://www.kaggle.com/kashnitsky/a3-demo-decision-trees). The assignment is just for you to practice, and goes with a [solution](https://www.kaggle.com/kashnitsky/a3-demo-decision-trees-solution).
# 
# ### Bonus version
# You can also choose a ["Bonus Assignments" tier](https://www.patreon.com/ods_mlcourse) (details are outlined on the [mlcourse.ai](https://mlcourse.ai/) main page) and get a non-demo version of the assignment where you'll applying decision trees to cardiovascular decease data. In one more bonus assignment, a more challenging one, you'll be guided through an __implementation of a decision tree from scratch__.
# 
...
# - If you read Russian: an [article](https://habrahabr.ru/company/ods/blog/322534/) on Habr.com with ~ the same material. And a [lecture](https://youtu.be/p9Hny3Cs6rk) on YouTube
