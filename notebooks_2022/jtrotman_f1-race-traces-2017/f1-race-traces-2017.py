...
# # Formula One Race Traces — 2017
# 
# This notebook shows race traces for each F1 race in 2017, using the [Formula 1 Race Data][2] data set, which is sourced from [ergast.com](http://ergast.com/mrd/),
...
YEAR = 2017
DRIVER_LS = {1:0,4:0,8:1,13:0,18:2,20:0,154:0,807:0,814:2,815:0,817:0,822:1,825:1,826:1,828:1,830:1,832:0,835:1,836:0,838:1,839:1,840:1,841:2,842:2,843:3}
DRIVER_C = {1:"#00CACA",4:"#7F7F7F",8:"#FF0000",13:"#007FFE",18:"#7F7F7F",20:"#FF0000",154:"#191919",807:"#B4B400",814:"#007FFE",815:"#FE7F00",817:"#0000B0",822:"#00CACA",825:"#191919",826:"#7B68EE",828:"#003B76",830:"#0000B0",832:"#7B68EE",835:"#B4B400",836:"#003B76",838:"#7F7F7F",839:"#FE7F00",840:"#007FFE",841:"#003B76",842:"#7B68EE",843:"#7B68EE"}
TEAM_C = {1:"#7F7F7F",3:"#007FFE",4:"#B4B400",5:"#7B68EE",6:"#FF0000",9:"#0000B0",10:"#FE7F00",15:"#003B76",131:"#00CACA",210:"#191919"}
LINESTYLES = ['-', '-.', '--', ':', '-', '-']


# # 2017 Formula One World Championship
# 
# For background see [Wikipedia](https://en.wikipedia.org/wiki/2017_Formula_One_World_Championship); here's an excerpt:
# 
...
# *This notebook uses material from the Wikipedia article <a href="https://en.wikipedia.org/wiki/2017_Formula_One_World_Championship">"2017 Formula One World Championship"</a>, which is released under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share-Alike License 3.0</a>.*
