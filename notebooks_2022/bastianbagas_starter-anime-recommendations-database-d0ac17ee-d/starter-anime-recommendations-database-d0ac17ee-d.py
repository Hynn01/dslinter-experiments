...
# ### Let's check 1st file: ../input/anime.csv
...
df1 = pd.read_csv('../input/anime.csv', delimiter=',', nrows = nRowsRead)
...
# ### Let's check 2nd file: ../input/rating.csv
...
df2 = pd.read_csv('../input/rating.csv', delimiter=',', nrows = nRowsRead)
