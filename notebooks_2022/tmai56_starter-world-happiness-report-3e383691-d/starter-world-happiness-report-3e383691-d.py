...
df1 = pd.read_csv('../input/2015.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 1000 # specify 'None' if want to read whole file
df2 = pd.read_csv('../input/2016.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 1000 # specify 'None' if want to read whole file
df3 = pd.read_csv('../input/2017.csv', delimiter=',', nrows = nRowsRead)
