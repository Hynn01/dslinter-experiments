...
# # Formula One Race Traces — 2013
# 
# This notebook shows race traces for each F1 race in 2013, using the [Formula 1 Race Data][2] data set, which is sourced from [ergast.com](http://ergast.com/mrd/),
...
YEAR = 2013
DRIVER_LS = {1:0,3:1,4:0,5:2,8:0,13:1,16:1,17:1,18:0,20:0,154:1,807:0,813:1,814:0,815:1,817:0,818:1,819:0,820:0,821:1,822:0,823:1,824:1}
DRIVER_C = {1:"#00CACA",3:"#00CACA",4:"#FF0000",5:"#666666",8:"#666666",13:"#FF0000",16:"#FE7F00",17:"#0000B0",18:"#7F7F7F",20:"#0000B0",154:"#666666",807:"#003B76",813:"#007FFE",814:"#FE7F00",815:"#7F7F7F",817:"#7B68EE",818:"#7B68EE",819:"#00DC00",820:"#B00000",821:"#003B76",822:"#007FFE",823:"#00DC00",824:"#B00000"}
...
# 
# For background see [Wikipedia](https://en.wikipedia.org/wiki/2013_Formula_One_World_Championship); here's an excerpt:
# 
...
# *This notebook uses material from the Wikipedia article <a href="https://en.wikipedia.org/wiki/2013_Formula_One_World_Championship">"2013 Formula One World Championship"</a>, which is released under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share-Alike License 3.0</a>.*
