...
# # Formula One Race Traces — 1996
# 
# This notebook shows race traces for each F1 race in 1996, using the [Formula 1 Race Data][2] data set, which is sourced from [ergast.com](http://ergast.com/mrd/),
...
YEAR = 1996
DRIVER_LS = {14:1,21:0,22:0,30:0,35:1,44:0,49:0,50:0,55:0,56:1,57:0,58:3,63:0,64:1,65:1,69:0,71:0,73:1,77:1,79:1,83:1,84:1,85:1,86:2}
DRIVER_C = {14:"#7F7F7F",21:"#C46200",22:"#7FFE00",30:"#FF0000",35:"#007FFE",44:"#0000FF",49:"#003B76",50:"#000000",55:"#00E3E3",56:"#FF0000",57:"#7F7F7F",58:"#C46200",63:"#9C009C",64:"#0000FF",65:"#003B76",69:"#CACA00",71:"#007FFE",73:"#000000",77:"#00E3E3",79:"#9C009C",83:"#C46200",84:"#7FFE00",85:"#CACA00",86:"#C46200"}
TEAM_C = {1:"#7F7F7F",3:"#007FFE",6:"#FF0000",15:"#003B76",17:"#7FFE00",18:"#C46200",22:"#00E3E3",25:"#9C009C",27:"#0000FF",28:"#CACA00",29:"#000000"}
LINESTYLES = ['-', '-.', '--', ':', '-', '-']


# # 1996 Formula One World Championship
# 
# For background see [Wikipedia](https://en.wikipedia.org/wiki/1996_Formula_One_World_Championship); here's an excerpt:
# 
...
# *This notebook uses material from the Wikipedia article <a href="https://en.wikipedia.org/wiki/1996_Formula_One_World_Championship">"1996 Formula One World Championship"</a>, which is released under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share-Alike License 3.0</a>.*
