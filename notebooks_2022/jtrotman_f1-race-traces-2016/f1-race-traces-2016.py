...
# # Formula One Race Traces — 2016
# 
# This notebook shows race traces for each F1 race in 2016, using the [Formula 1 Race Data][2] data set, which is sourced from [ergast.com](http://ergast.com/mrd/),
...
YEAR = 2016
DRIVER_LS = {1:0,3:1,4:0,8:1,13:1,18:1,20:0,154:0,807:1,815:0,817:0,821:1,822:0,825:0,826:1,828:1,830:1,831:0,832:0,835:1,836:0,837:1,838:2,839:2}
DRIVER_C = {1:"#00CACA",3:"#00CACA",4:"#7F7F7F",8:"#FF0000",13:"#007FFE",18:"#7F7F7F",20:"#FF0000",154:"#191919",807:"#FE7F00",815:"#FE7F00",817:"#0000B0",821:"#191919",822:"#007FFE",825:"#B4B400",826:"#7B68EE",828:"#003B76",830:"#0000B0",831:"#003B76",832:"#7B68EE",835:"#B4B400",836:"#B00000",837:"#B00000",838:"#7F7F7F",839:"#B00000"}
TEAM_C = {1:"#7F7F7F",3:"#007FFE",4:"#B4B400",5:"#7B68EE",6:"#FF0000",9:"#0000B0",10:"#FE7F00",15:"#003B76",131:"#00CACA",209:"#B00000",210:"#191919"}
LINESTYLES = ['-', '-.', '--', ':', '-', '-']


# # 2016 Formula One World Championship
# 
# For background see [Wikipedia](https://en.wikipedia.org/wiki/2016_Formula_One_World_Championship); here's an excerpt:
# 
...
# *This notebook uses material from the Wikipedia article <a href="https://en.wikipedia.org/wiki/2016_Formula_One_World_Championship">"2016 Formula One World Championship"</a>, which is released under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share-Alike License 3.0</a>.*
