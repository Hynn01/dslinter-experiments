...
# # Formula One Race Traces — 2007
# 
# This notebook shows race traces for each F1 race in 2007, using the [Formula 1 Race Data][2] data set, which is sourced from [ergast.com](http://ergast.com/mrd/),
...
YEAR = 2007
DRIVER_LS = {1:0,2:0,3:0,4:1,5:0,6:2,8:0,9:1,11:0,13:1,14:0,15:0,16:0,17:1,18:0,19:1,20:0,21:1,22:1,23:1,24:1,25:1,26:2,27:1,28:3,29:2}
DRIVER_C = {1:"#7F7F7F",2:"#BABABA",3:"#007FFE",4:"#7F7F7F",5:"#B4B400",6:"#007FFE",8:"#FF0000",9:"#BABABA",11:"#580000",13:"#FF0000",14:"#0000B0",15:"#E300E3",16:"#763B00",17:"#0000B0",18:"#00B000",19:"#580000",20:"#7B68EE",21:"#B4B400",22:"#00B000",23:"#E300E3",24:"#7B68EE",25:"#007FFE",26:"#7B68EE",27:"#763B00",28:"#763B00",29:"#763B00"}
TEAM_C = {1:"#7F7F7F",2:"#BABABA",3:"#007FFE",4:"#B4B400",5:"#7B68EE",6:"#FF0000",7:"#E300E3",8:"#580000",9:"#0000B0",11:"#00B000",12:"#763B00"}
LINESTYLES = ['-', '-.', '--', ':', '-', '-']


# # 2007 Formula One World Championship
# 
# For background see [Wikipedia](https://en.wikipedia.org/wiki/2007_Formula_One_World_Championship); here's an excerpt:
# 
...
# 
# This was also the final season since its reintroduction in 2001 in which the use of traction control was permitted. Standardised engine control units (ECUs) were mandated from the 2008 season onwards, which prevented teams from using the technology.
# 
# Honda ran with an "Earth livery" on their RA107 car. It was the first time since 1968, the year in which sponsorship in the sport became widespread, that a team ran sponsor-free for an entire season.
# 
# Michelin's withdrawal from F1 at the end of 2006 meant that Bridgestone was the sole tyre supplier for 2007.
# 
# As of 2020, this is the last Drivers' Championship won by a driver of Ferrari.
...
# *This notebook uses material from the Wikipedia article <a href="https://en.wikipedia.org/wiki/2007_Formula_One_World_Championship">"2007 Formula One World Championship"</a>, which is released under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share-Alike License 3.0</a>.*
