...
# # Formula One Race Traces — 2000
# 
# This notebook shows race traces for each F1 race in 2000, using the [Formula 1 Race Data][2] data set, which is sourced from [ergast.com](http://ergast.com/mrd/),
...
YEAR = 2000
DRIVER_LS = {2:0,14:1,15:1,18:1,21:0,22:1,23:0,25:1,30:0,35:0,37:1,41:1,48:0,49:0,50:0,54:1,55:1,56:0,57:0,60:1,63:0,64:1,65:2}
DRIVER_C = {2:"#0000B0",14:"#7F7F7F",15:"#7FFE00",18:"#007FFE",21:"#00E3E3",22:"#FF0000",23:"#007FFE",25:"#00E3E3",30:"#FF0000",35:"#9E004F",37:"#7F00FE",41:"#9E004F",48:"#C46200",49:"#7FFE00",50:"#7F00FE",54:"#008400",55:"#0000B0",56:"#008400",57:"#7F7F7F",60:"#C46200",63:"#003B76",64:"#003B76",65:"#008400"}
...
# 
# For background see [Wikipedia](https://en.wikipedia.org/wiki/2000_Formula_One_World_Championship); here's an excerpt:
# 
...
# *This notebook uses material from the Wikipedia article <a href="https://en.wikipedia.org/wiki/2000_Formula_One_World_Championship">"2000 Formula One World Championship"</a>, which is released under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share-Alike License 3.0</a>.*
