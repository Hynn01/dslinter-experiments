...
# ## GANime
# 
# This data is from [Mckinsey666](https://github.com/Mckinsey666/Anime-Face-Dataset) and the DCGAN implimentation is from the [DCGAN Tutorial](https://pytorch.org/tutorials/beginner/dcgan_faces_tutorial.html) which uses this [research](https://arxiv.org/abs/1511.06434) for technical aspects. I am simply having fun, hopefully sharing knowledge, and attempting to generate some cute waifus.
# 
# The goal of this paper is to generate girls like this:
