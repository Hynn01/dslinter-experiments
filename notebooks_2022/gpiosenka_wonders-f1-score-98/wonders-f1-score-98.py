...
# ### The dataset is not balanced and has more images per class than is necessary. Limit the number of images in each class
# ### to 150 using the trim function defined below
