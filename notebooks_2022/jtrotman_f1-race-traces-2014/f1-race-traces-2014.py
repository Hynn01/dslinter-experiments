...
# # Formula One Race Traces — 2014
# 
# This notebook shows race traces for each F1 race in 2014, using the [Formula 1 Race Data][2] data set, which is sourced from [ergast.com](http://ergast.com/mrd/),
...
YEAR = 2014
DRIVER_LS = {1:0,3:1,4:0,8:1,13:1,16:0,18:0,20:1,154:0,155:0,807:0,813:1,815:1,817:0,818:0,820:1,821:1,822:0,824:0,825:1,826:1,827:1,828:2,829:3}
DRIVER_C = {1:"#00CACA",3:"#00CACA",4:"#FF0000",8:"#FF0000",13:"#007FFE",16:"#003B76",18:"#7F7F7F",20:"#0000B0",154:"#666666",155:"#00DC00",807:"#FE7F00",813:"#666666",815:"#FE7F00",817:"#0000B0",818:"#7B68EE",820:"#B00000",821:"#003B76",822:"#007FFE",824:"#B00000",825:"#7F7F7F",826:"#7B68EE",827:"#00DC00",828:"#00DC00",829:"#00DC00"}
TEAM_C = {1:"#7F7F7F",3:"#007FFE",5:"#7B68EE",6:"#FF0000",9:"#0000B0",10:"#FE7F00",15:"#003B76",131:"#00CACA",206:"#B00000",207:"#00DC00",208:"#666666"}
LINESTYLES = ['-', '-.', '--', ':', '-', '-']


# # 2014 Formula One World Championship
# 
# For background see [Wikipedia](https://en.wikipedia.org/wiki/2014_Formula_One_World_Championship); here's an excerpt:
# 
...
# *This notebook uses material from the Wikipedia article <a href="https://en.wikipedia.org/wiki/2014_Formula_One_World_Championship">"2014 Formula One World Championship"</a>, which is released under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share-Alike License 3.0</a>.*
