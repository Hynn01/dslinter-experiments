...
# # Formula One Race Traces — 1999
# 
# This notebook shows race traces for each F1 race in 1999, using the [Formula 1 Race Data][2] data set, which is sourced from [ergast.com](http://ergast.com/mrd/),
...
YEAR = 1999
DRIVER_LS = {14:1,15:0,21:0,22:0,23:0,25:1,30:0,35:0,37:0,41:1,44:1,48:0,49:0,55:1,56:1,57:0,63:2,64:0,65:1,68:1,69:1,70:1,71:1,72:2}
DRIVER_C = {14:"#7F7F7F",15:"#0000B0",21:"#00E3E3",22:"#BABABA",23:"#007FFE",25:"#00E3E3",30:"#FF0000",35:"#9E004F",37:"#7F00FE",41:"#9E004F",44:"#0000B0",48:"#C46200",49:"#7FFE00",55:"#003B76",56:"#FF0000",57:"#7F7F7F",63:"#FF0000",64:"#003B76",65:"#BABABA",68:"#7F00FE",69:"#C46200",70:"#007FFE",71:"#7FFE00",72:"#C46200"}
TEAM_C = {1:"#7F7F7F",3:"#007FFE",6:"#FF0000",15:"#003B76",16:"#9E004F",17:"#7FFE00",18:"#C46200",20:"#0000B0",21:"#7F00FE",22:"#00E3E3",24:"#BABABA"}
LINESTYLES = ['-', '-.', '--', ':', '-', '-']


# # 1999 Formula One World Championship
# 
# For background see [Wikipedia](https://en.wikipedia.org/wiki/1999_Formula_One_World_Championship); here's an excerpt:
# 
...
# *This notebook uses material from the Wikipedia article <a href="https://en.wikipedia.org/wiki/1999_Formula_One_World_Championship">"1999 Formula One World Championship"</a>, which is released under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share-Alike License 3.0</a>.*
