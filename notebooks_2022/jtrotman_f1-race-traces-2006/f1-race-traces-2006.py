...
# # Formula One Race Traces — 2006
# 
# This notebook shows race traces for each F1 race in 2006, using the [Formula 1 Race Data][2] data set, which is sourced from [ergast.com](http://ergast.com/mrd/),
...
YEAR = 2006
DRIVER_LS = {2:0,3:1,4:0,8:0,9:2,11:0,13:1,14:0,15:1,17:0,18:0,21:1,22:1,23:0,24:0,26:1,27:0,29:1,30:0,31:1,32:1,33:1,34:2,35:1,36:3,37:2,38:2}
DRIVER_C = {2:"#BABABA",3:"#007FFE",4:"#B4B400",8:"#7F7F7F",9:"#BABABA",11:"#580000",13:"#FF0000",14:"#0000B0",15:"#E300E3",17:"#007FFE",18:"#00B000",21:"#B4B400",22:"#00B000",23:"#E300E3",24:"#7B68EE",26:"#7B68EE",27:"#000000",29:"#580000",30:"#FF0000",31:"#7F7F7F",32:"#0000B0",33:"#000000",34:"#580000",35:"#BABABA",36:"#580000",37:"#7F7F7F",38:"#0000B0"}
TEAM_C = {1:"#7F7F7F",2:"#BABABA",3:"#007FFE",4:"#B4B400",5:"#7B68EE",6:"#FF0000",7:"#E300E3",8:"#580000",9:"#0000B0",11:"#00B000",13:"#000000",14:"#000000"}
LINESTYLES = ['-', '-.', '--', ':', '-', '-']


# # 2006 Formula One World Championship
# 
# For background see [Wikipedia](https://en.wikipedia.org/wiki/2006_Formula_One_World_Championship); here's an excerpt:
# 
...
# *This notebook uses material from the Wikipedia article <a href="https://en.wikipedia.org/wiki/2006_Formula_One_World_Championship">"2006 Formula One World Championship"</a>, which is released under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share-Alike License 3.0</a>.*
