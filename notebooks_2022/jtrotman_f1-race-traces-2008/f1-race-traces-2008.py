...
# # Formula One Race Traces — 2008
# 
# This notebook shows race traces for each F1 race in 2008, using the [Formula 1 Race Data][2] data set, which is sourced from [ergast.com](http://ergast.com/mrd/),
...
YEAR = 2008
DRIVER_LS = {1:0,2:1,3:0,4:0,5:1,6:1,7:1,8:1,9:0,10:1,11:0,12:1,13:0,14:1,15:0,16:0,17:0,18:1,19:1,20:0,21:1,22:0}
DRIVER_C = {1:"#7F7F7F",2:"#BABABA",3:"#007FFE",4:"#B4B400",5:"#7F7F7F",6:"#007FFE",7:"#7B68EE",8:"#FF0000",9:"#BABABA",10:"#E300E3",11:"#580000",12:"#B4B400",13:"#FF0000",14:"#0000B0",15:"#E300E3",16:"#FE7F00",17:"#0000B0",18:"#00B000",19:"#580000",20:"#7B68EE",21:"#FE7F00",22:"#00B000"}
TEAM_C = {1:"#7F7F7F",2:"#BABABA",3:"#007FFE",4:"#B4B400",5:"#7B68EE",6:"#FF0000",7:"#E300E3",8:"#580000",9:"#0000B0",10:"#FE7F00",11:"#00B000"}
LINESTYLES = ['-', '-.', '--', ':', '-', '-']


# # 2008 Formula One World Championship
# 
# For background see [Wikipedia](https://en.wikipedia.org/wiki/2008_Formula_One_World_Championship); here's an excerpt:
# 
...
# *This notebook uses material from the Wikipedia article <a href="https://en.wikipedia.org/wiki/2008_Formula_One_World_Championship">"2008 Formula One World Championship"</a>, which is released under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share-Alike License 3.0</a>.*
