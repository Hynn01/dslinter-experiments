...
# ### Let's check 1st file: ../input/list_attr_celeba.csv
...
df1 = pd.read_csv('../input/list_attr_celeba.csv', delimiter=',', nrows = nRowsRead)
...
# ### Let's check 2nd file: ../input/list_bbox_celeba.csv
...
df2 = pd.read_csv('../input/list_bbox_celeba.csv', delimiter=',', nrows = nRowsRead)
...
# ### Let's check 3rd file: ../input/list_eval_partition.csv
...
df3 = pd.read_csv('../input/list_eval_partition.csv', delimiter=',', nrows = nRowsRead)
