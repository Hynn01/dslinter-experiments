...
# # Formula One Race Traces — 1997
# 
# This notebook shows race traces for each F1 race in 1997, using the [Formula 1 Race Data][2] data set, which is sourced from [ergast.com](http://ergast.com/mrd/),
...
YEAR = 1997
DRIVER_LS = {14:0,15:0,21:0,22:0,23:1,25:2,30:0,35:0,44:0,49:1,50:1,55:0,56:1,57:1,58:1,63:0,64:1,65:0,71:0,73:0,75:1,76:1,77:1,78:1,79:2,80:1,81:2,82:3}
DRIVER_C = {14:"#7F7F7F",15:"#C46200",21:"#7FFE00",22:"#BABABA",23:"#7FFE00",25:"#00E3E3",30:"#FF0000",35:"#007FFE",44:"#0000B0",49:"#007FFE",50:"#9C009C",55:"#00E3E3",56:"#FF0000",57:"#7F7F7F",58:"#C46200",63:"#9C009C",64:"#7F00FE",65:"#003B76",71:"#7F00FE",73:"#000000",75:"#0000B0",76:"#BABABA",77:"#00E3E3",78:"#003B76",79:"#C46200",80:"#000000",81:"#003B76",82:"#003B76"}
TEAM_C = {1:"#7F7F7F",3:"#007FFE",6:"#FF0000",15:"#003B76",17:"#7FFE00",18:"#C46200",20:"#0000B0",21:"#7F00FE",22:"#00E3E3",24:"#BABABA",25:"#9C009C",26:"#000000"}
LINESTYLES = ['-', '-.', '--', ':', '-', '-']


# # 1997 Formula One World Championship
# 
# For background see [Wikipedia](https://en.wikipedia.org/wiki/1997_Formula_One_World_Championship); here's an excerpt:
# 
...
# 
# As of 2020, this was the last time the championship was won by a non-European driver, the last Constructors' and Drivers' championships for Williams.
...
# *This notebook uses material from the Wikipedia article <a href="https://en.wikipedia.org/wiki/1997_Formula_One_World_Championship">"1997 Formula One World Championship"</a>, which is released under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share-Alike License 3.0</a>.*
